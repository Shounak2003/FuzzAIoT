...
#define ATTACKER_DoS_RATE "40960kb/s"   // Increased rate to generate more traffic
...
int main(int argc, char *argv[])
{
    ...
    onoff.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant=0]")); // Continuous attack
    ...
    AnimationInterface anim("LowRateTCPDoS_Training.xml");
